...
from api.extrato_compra_api import ExtratoCompraAPI  # Importando a API
...
class ExtratoCompraDialog(ComponentDialog):
        ...
        self.add_dialog(
            WaterfallDialog(
                ...
                [
                    ...
                    self.consultar_extrato_compras_step,  # Consultar extrato de compras
                ],
            )
        )
    ...
    async def consultar_extrato_compras_step(self, step_context: WaterfallStepContext):
        ...
        extrato_api = ExtratoCompraAPI()  # Instanciando a API
        pedidos = extrato_api.consultar_extrato_compras(usuario_id)  # Chamando o método para buscar os pedidos
